...
function particleGenerator() {
  var size = jmParticleEngine.randomNumber(256);
  ...
  return jmParticleEngine.generateParticle(
      ...
      0,
      // yVelocity.
      jmParticleEngine.randomNumber(18, 18),
      // Life.
      64,
...
function randXEmit() {
  emit1.x = jmParticleEngine.randomNumber(window.innerWidth);
  setTimeout(randXEmit, 100);
}

// Start emitting from random x positions on canvas.
randXEmit();
